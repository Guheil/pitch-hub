    ...
    >
      <div className="min-h-screen">
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="bg-white/10 dark:bg-black/20 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-lg">
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span>hello@foundersframe.com</span>
                    </div>
                    <div className="flex items-center gap-3">
                ...
                >
                  ...
                  <Card className="bg-white/50 dark:bg-black/20 backdrop-blur-sm">
                    <p className="text-foreground/80">
                      Join our newsletter to stay updated on the latest features, resources, and community events.
                    </p>
                    <div className="mt-4 flex gap-2">
                      <input
                        type="email"
                        placeholder="Your email address"
                        className="flex-1 px-4 py-2 rounded-lg bg-white/50 dark:bg-black/20 border border-white/20 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
